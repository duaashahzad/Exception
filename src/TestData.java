...
public class TestData
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        String file = "\\Users\\smazi\\IdeaProjects\\Exception_Ex\\test1.dat";

        IOException exio = new IOException();
...
// Search JAVA API for use of each Writer class above
// Read the test.dat file to the console
// EX 10.6